...
class User_activity_etl_model extends CI_Model {
    ...
    public function get_user_activity_data_paginated($course_id = null, $date = null, $limit = null, $offset = 0)
    {
        ...
        $sql = "
            ...
            WHERE c.visible = 1
            GROUP BY c.id, c.idnumber, c.fullname, c.shortname, uc.num_teachers, uc.num_students, ac.file_views, ac.video_views, ac.forum_views, ac.quiz_views, ac.assignment_views, ac.url_views, ac.active_days
        ";
    ...
    public function run_etl_process($extraction_date = null)
    {
        ...
        try {
            ...
            // Get activity counts - Note: This should use Activity_counts_model
            // $activity_counts = $this->get_activity_counts_all();
            // $this->insert_activity_counts_etl($activity_counts, $extraction_date);
            
            // Get user counts - Note: This should use User_counts_model  
            // $user_counts = $this->get_user_counts_all();
            // $this->insert_user_counts_etl($user_counts, $extraction_date);
