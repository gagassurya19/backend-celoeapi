...
class Migrate extends CI_Controller {
	...
	public function run($target_version = null)
	{
		...
		if ($target_version) {
			...
			echo "Target migration version: " . str_pad($target_version, 3, '0', STR_PAD_LEFT) . "\n";
			...
			echo "Latest migration version: " . str_pad($latest_version, 3, '0', STR_PAD_LEFT) . "\n";
...
class {$class_name} extends CI_Migration {
	...
	private function show_usage()
	{
		...
		echo "  ./migrate.sh run <version>    - Run migrations to specific version\n";
